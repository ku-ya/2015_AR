...
In the prediction process, the target belief $\p{\Vxbp{k}{t}|\ptVzbp{s}{1:k-1}{t},\tVxp{s}}$ is updated from that in the previous time step \linebreak[4]$\p{\Vxbp{k-1}{t}|\ptVzbp{s}{1:k-1}{t},\tVxp{s}}$ by Chapman-Kolmogorov equation as
...
\begin{figure}[ht]
	\centering
	\includegraphics[width = \columnwidth]{Figures/optical.png} % PDF
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.6\columnwidth]{Figures/FOV.png} % PDF
...
\begin{figure}[ht]
	\centering
	\includegraphics[width = 8cm]{Figures/acoustic.png} % PDF
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\columnwidth]{Figures/joint.png} % PDF
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\columnwidth]{Figures/posterior.png} % PDF
...
\begin{figure}[ht]
	\centering
	\includegraphics[width = 8cm]{Figures/likelihood.png} % PDF
...
\begin{figure}[ht]
  ...
  \subfigure[Schematic design]{
    \label{fig:pma}
    \includegraphics[width=0.46\columnwidth]{Figures/experiment_schematics3.png} % PDF
}
  \subfigure[Developed system]{
    \label{fig:pmb}
    \includegraphics[width=0.46\columnwidth]{Figures/experiment_photo.jpg} % PDF
  }
...
Figure~\ref{fig:ILDs} shows the six ILDs each observed with a target at one of the 54 positions when $\bl{L_d, L_w, n_w} = \bl{50, 40, 1}$.  Two positions are on the LOS, and four are on the NLOS.  It is first seen that the configuration of the ILD varies depending on the target position.  The configuration is different even when the target is on the NLOS.  This indicates that the ILD contains information on the target position no matter whether the target is on the LOS.  

\begin{figure}[ht]
	\centering
	\subfigure[$\bl{60,0}$ (LOS)]{
		\label{fig:l1}
		\includegraphics[width = 0.45\columnwidth]{Figures/pos006step001.png} % PDF
		}
	\subfigure[$\bl{36,34}$ (NLOS)]{
		\label{fig:l2}
		\includegraphics[width =  0.45\columnwidth]{Figures/pos022step001.png} % PDF
	}
	\subfigure[$\bl{24,56}$ (NLOS)]{
		\label{fig:l3}
		\includegraphics[width =  0.45\columnwidth]{Figures/pos033step001.png} % PDF
	}
	\subfigure[$\bl{12,90}$ (LOS)]{
		\label{fig:l4}
		\includegraphics[width =  0.45\columnwidth]{Figures/pos050step001.png} % PDF
	}
...
\begin{figure}[ht]
  ...
  \subfigure[$L_d=0, L_w=70, n_w=1$]{
    \label{fig:al1}
    \includegraphics[trim = 30mm 5mm 30mm 15mm,clip,width = 0.468\columnwidth]{Figures/w1_Lw70_Ld0_step023.png} % PDF
  }
  \subfigure[$L_d=30, L_w=70, n_w=1$]{
    \label{fig:al2}
    \includegraphics[trim = 30mm 5mm 30mm 15mm,clip,width =  0.468\columnwidth]{Figures/w1_Lw70_Ld30_step023.png} % PDF
  }
  \subfigure[$L_d=20, L_w=50, n_w=2$]{
    \label{fig:al3}
    \includegraphics[trim = 30mm 5mm 30mm 15mm,clip,width =  0.468\columnwidth]{Figures/w2_Lw50_Ld20_step033.png} % PDF
  }
  \subfigure[$L_d=20, L_w=70, n_w=2$]{
    \label{fig:al4}
    \includegraphics[trim = 30mm 5mm 30mm 15mm,clip,width =  0.468\columnwidth]{Figures/w2_Lw70_Ld20_step033.png} % PDF
}
...
\begin{figure}[ht]
  ...
  \subfigure[Single wall mean error]{
    \label{fig:msw}
    \includegraphics[width = 0.468\columnwidth]{Figures/w1_error.PNG} % PDF
  }
  \subfigure[Double wall mean error]{
    \label{fig:mdw}
	\includegraphics[width = 0.468\columnwidth]{Figures/w2_error.PNG}
  }
   \subfigure[Diferential entropy for single and double wall]{
   	\label{fig:de}
   	\includegraphics[width = 0.468\columnwidth]{Figures/H_1w2w.PNG} % PDF
  }
...
\begin{figure}[ht]
	\centering
	\includegraphics[width = 0.8\columnwidth]{Figures/map.png} % PDF
...
\begin{figure}[ht]
	\centering
	\includegraphics[width = 0.8\columnwidth]{Figures/system.png} % PDF
...
\begin{figure}[ht]
  ...
  \subfigure[$k=1$ (FOV)]{
    \label{fig:a1}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig9/Figure1.png} % PDF
  }
  \subfigure[$k=7$ (NFOV)]{
    \label{fig:a2}
    \includegraphics[trim =  15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig9/Figure2.png} % PDF
  }
  \subfigure[$k=35$ (NFOV)]{
    \label{fig:a3}
    \includegraphics[trim =  15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig9/Figure3.png} % PDF
  }
  \subfigure[$k=51$ (NFOV)]{
    \label{fig:a4}
    \includegraphics[trim =  15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig9/Figure4.png} % PDF
  }
...
\begin{figure}[ht]
  ...
  \subfigure[$k=1$ (FOV)]{
    \label{fig:o1}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig10/Figure1.png} % PDF
  }
  \subfigure[$k=7$ (NFOV)]{
    \label{fig:o2}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig10/Figure2.png} % PDF
  }
  \subfigure[$k=35$ (NFOV)]{
    \label{fig:o3}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig10/Figure3.png} % PDF
  }
  \subfigure[$k=51$ (NFOV)]{
    \label{fig:o4}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig10/Figure4.png} % PDF
  }
...
\begin{figure}[ht]
  ...
  \subfigure[$k=1$ (FOV)]{
    \label{fig:j1}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig11/Figure1.png} % PDF
  }
  \subfigure[$k=7$ (NFOV)]{
    \label{fig:j2}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig11/Figure2.png} % PDF
  }
  \subfigure[$k=35$ (NFOV)]{
    \label{fig:j3}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig11/Figure3.png} % PDF
  }
  \subfigure[$k=51$ (NFOV)]{
    \label{fig:j4}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig11/Figure4.png} % PDF
  }
...
\begin{figure}[ht]
  ...
  \subfigure[$k=1$ (FOV)]{
    \label{fig:12-1}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig12/Figure1.png} % PDF
  }
  \subfigure[$k=7$ (NFOV)]{
    \label{fig:12-7}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig12/Figure7.png} % PDF
  }
  \subfigure[$k=35$ (NFOV)]{
    \label{fig:12-35}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig12/Figure35.png} % PDF
  }
  \subfigure[$k=51$ (NFOV)]{
    \label{fig:12-51}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig12/Figure51.png} % PDF
  }
...
\begin{figure}[ht]
  ...
  \subfigure[$k=1$ (FOV)]{
    \label{fig:13-1}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig13/Figure1.png} % PDF
  }
  \subfigure[$k=7$ (NFOV)]{
    \label{fig:13-7}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig13/Figure7.png} % PDF
  }
  \subfigure[$k=35$ (NFOV)]{
    \label{fig:13-35}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig13/Figure35.png} % PDF
  }
  \subfigure[$k=51$ (NFOV)]{
    \label{fig:13-51}
    \includegraphics[trim = 15mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig13/Figure51.png} % PDF
  }
...
\begin{figure}[ht]
  ...
  \subfigure[Error vs time step]{
    \label{fig:error}
    \includegraphics[trim = 0mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig14/Fig14_Error.png} % PDF
  }
  \subfigure[KL divergence vs time step]{
    \label{fig:kl}
    \includegraphics[trim = 0mm 0mm 15mm 0mm,clip,width = 0.46\columnwidth]{Figures/Fig14/Fig14_KLD.png} % PDF
  }
...
\bibliography{reference/cite_cur}   % name your BibTeX data base

\parpic{\includegraphics[width=1in,clip,keepaspectratio]{figures/kuya.jpg}}
...
\parpic{\includegraphics[width=1in,clip,keepaspectratio]{figures/furukawa.jpg}}
