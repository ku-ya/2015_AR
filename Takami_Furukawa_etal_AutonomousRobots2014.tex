...
\usepackage[pagebackref=true,breaklinks=true,colorlinks,linkcolor=green,bookmarks=false,citecolor=blue]{hyperref}
...
\nomenclature{$\Vxbp{k+1}{t}$}{The state of the target at time step $k$}
...
\item [sdaf] test
\end{itemize}
%{$\Vxbp{k+1}{t}$}{The state of the target at time step $k$}
